...
public class TableFieldMetadataControllerTest {
    ...
    public static TableFieldMetadataDto dto;
    ...
    private void checkResult(List<TableFieldMetadataDto> result) {
        Assertions.assertNotNull(result);
        result.stream().findFirst().ifPresent(it -> {
            Assertions.assertEquals(dto.getDbName(), it.getDbName());
            Assertions.assertEquals(dto.getDbDescription(), it.getDbDescription());
            Assertions.assertEquals(dto.getSchemaName(), it.getSchemaName());
            Assertions.assertEquals(dto.getSchemaDescription(), it.getSchemaDescription());
            Assertions.assertEquals(dto.getTableName(), it.getTableName());
            Assertions.assertEquals(dto.getTableDescription(), it.getTableDescription());
            Assertions.assertEquals(dto.getColumnName(), it.getColumnName());
            Assertions.assertEquals(dto.getColumnDescription(), it.getColumnDescription());
            Assertions.assertEquals(dto.getColumnType(), it.getColumnType());
        }
        );
    }

    private void checkResult(ErrorResponse error, String errorMessage) {
